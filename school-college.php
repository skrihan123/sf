...
<head>
    <title>School & College Outreach</title>
    ...
    <div class="rs-breadcrumbs">
        <div class="breadcrumbs-wrap">
            <img src="images/banner/isf-banner-1.png" alt="Breadcrumbs Image">
            <div class="breadcrumbs-inner vertical-middle">
                <div class="container">
                    <div class="breadcrumbs-text">
                        <h1 class="breadcrumbs-title margin-0" style="padding-top: 110px;">School & College Outreach </h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="rs-single-club sec-bg md-pb-80">
        <div class="container">
            ...
            <div class="rs-carousel owl-carousel" data-loop="true" data-items="1" data-margin="30" data-autoplay="true" data-autoplay-timeout="8000" data-smart-speed="2000" data-dots="false" data-nav="true" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="1" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="1" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="1" data-md-device-nav="true" data-md-device-dots="false">
                <div class="items">
                    <a href="#">
                        ...
                        <div class="teams">
                            <div class="logo">
                                <img class="size-80" src="images/team-logo/8.png" alt="Man City">
                                <div class="name">Man City</div>
                            </div>
                            <div class="time-vs">
                                <span class="time primary-color">12:00</span>
                ...
                <div class="items">
                    <a href="#">
                        ...
                        <div class="teams">
                            ...
                            <div class="time-vs">
                                <span class="time primary-color">03:00</span>
                                <span class="vs">vs</span>
                            </div>
                            <div class="logo">
                                <img class="size-80" src="images/team-logo/7.png" alt="Arsenal">
            ...
            <!-- <div class="row pt-100 md-pt-80">
            <div class="col-lg-3 col-md-12 md-mb-30">
                <div class="club-logo text-center">
                    <img src="images/team-logo/7.png" alt="Arsenal">
                </div>
            </div>
            <div class="col-lg-9 col-md-12">
                ...
                <div class="rs-count center-md mb-100 md-mb-71">
                    <div class="row">
                        <div class="col-lg-3 col-6 md-mb-30">
                            <div class="rs-counter-list">
                                <h2 class="counter-number">1890</h2>
                                <h4 class="counter-text">Established in</h4>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6 md-mb-30">
                            <div class="rs-counter-list">
                                <h2 class="counter-number">124</h2>
                                <h4 class="counter-text">Champions</h4>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                            <div class="rs-counter-list">
                                <h2 class="counter-number">168</h2>
                                <h4 class="counter-text">Current Players</h4>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                            <div class="rs-counter-list">
                                <h2 class="counter-number">82</h2>
                                <h4 class="counter-text">Top Players</h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="rs-tab pb-90 md-pb-60">
                <div class="club-details_data">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#club-history">Club history</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#squad-list">Players</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#champion">Champion</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#gallery">Gallery</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#jersy">Jersy</a>
                    </li>
                </ul> -->
                    ...
                    <div class="tab-content">
                            ...
                            <div class="about-club">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 mt-5">
                                        <p>Iconic Sports Federation is committed to shaping the future of sports in India. Through our School & College Outreach Programs, we aim to create awareness, build career paths, and encourage sports entrepreneurship among youth.</p>
                                        <p class="margin-0">We believe every student has the potential to lead in sports—not just on the field, but as innovators, strategists, and changemakers.</p>
                                        ...
                                        <h5>1. Career in Sports</h5>
                                        <p><i class="fa-solid fa-arrow-right"></i> Roadmap to becoming a professional athlete</p>
                                        <p><i class="fa-solid fa-arrow-right"></i> Roles in coaching, physiotherapy, sports analytics, and management</p>
                                        <p><i class="fa-solid fa-arrow-right"></i> National and international career opportunities</p>


                                        <h5>2. Sports Entrepreneurship</h5>
                                        <p><i class="fa-solid fa-arrow-right"></i> Build your own gym, academy, or sports venture</p>
                                        <p><i class="fa-solid fa-arrow-right"></i> Introduction to sports startups and business incubation</p>
                                        <p><i class="fa-solid fa-arrow-right"></i> Guidance on funding, branding, and digital marketing</p>


                                        <h5>3. Skill Development Workshops</h5>
                                        <p><i class="fa-solid fa-arrow-right"></i> Leadership, teamwork, and communication through sports</p>
                                        <p><i class="fa-solid fa-arrow-right"></i> Fitness, nutrition, and wellness awareness</p>
                                        <p><i class="fa-solid fa-arrow-right"></i> Sports tech & innovation sessions</p>

                                        <h5>4. Mentorship & Internship</h5>
                                        <p><i class="fa-solid fa-arrow-right"></i> Real-time mentorship with experts</p>
                                        <p><i class="fa-solid fa-arrow-right"></i> Internship opportunities with clubs, startups & federations</p>
                                        <p><i class="fa-solid fa-arrow-right"></i> Resume building and interview preparation</p>
                                        ...
                                        <p><i class="fa-solid fa-arrow-right"></i> Take your first step towards a fulfilling career in sports.</p>
                                        <p><i class="fa-solid fa-arrow-right"></i> Access guidance from top professionals</p>
                                        <p><i class="fa-solid fa-arrow-right"></i> Get certified for skills development</p>
                                        <p><i class="fa-solid fa-arrow-right"></i> Join our growing community of youth athletes and entrepreneurs</p>

                                        <h5><a href="#">register</a></h5>
                                    </div>

                                    <div class="col-md-6 col-sm-6 mt-5">
                                        <img class="alignright" src="images/about/school-sports.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- <div class="tab-pane fade" id="squad-list">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 sm-mb-30">
                                    <div class="squad-list-item">
                                        ...
                                        <div class="name">
                                            <a href="team-single.html">Fernando Grape</a>
                                        </div>
                                        <div class="position">Forward</div>
                                        <div class="jersy">12</div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="squad-list-item">
                                        ...
                                        <div class="name">
                                            <a href="team-single.html">Alex Grape</a>
                                        </div>
                                        <div class="position">Forward</div>
                                        <div class="jersy">19</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- <div class="tab-pane fade" id="champion">
                        ...
                        <!-- <div class="tab-pane fade" id="jersy">
                        <div class="club-jersy">
                            <div class="row">
                                <div class="col-lg-4 col-md-6 sm-mb-30">
                                    <div class="champion-logo">
                                        <img src="images/jersy/1.jpg" alt="jersy">
                                    </div>
                                    <div class="champion-details">
                                        <div class="year-details">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="champion-logo">
                                        <img src="images/jersy/2.jpg" alt="jersy">
                                    </div>
                                    <div class="champion-details">
                                        <div class="year-details">
            ...
            <div class="club-videos pb-90 md-pb-70">
                <div class="title-style pb-50 md-pb-30">
                    <h2 class="margin-0 uppercase">Club Videos</h2>
            ...
            <!-- <div class="rs-blog pb-100 md-pb-80">
            <div class="title-style pb-50 md-pb-30">
                <h2 class="margin-0 uppercase">Club News</h2>
                <span class="line-bg y-b pt-10 left-line"></span>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-12 md-mb-30">
                    <div class="blog-item ">
                        <div class="blog-img">
                            <div class="image-wrap">
                                <a href="#"><img src="images/club-news/1.jpg" alt=""></a>
                            </div>
                            <div class="all-meta">
                        ...
                        <div class="blog-content">
                            <h4 class="blog-title">
                                <a href="#">Ground Round Football Starts Right Here</a>
                            </h4>
                            <div class="blog-desc"> The snatch is a wide-grip, one-move lift. The clean and jerk is a close-grip, two-move lift. Each...</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 md-mb-30">
                    <div class="blog-item ">
                        <div class="blog-img">
                            <div class="image-wrap">
                                <a href="#"><img src="images/club-news/2.jpg" alt=""></a>
                            </div>
                            <div class="all-meta">
                                <div class="meta meta-date">
                                    <span class="month-day">20</span>
                        ...
                        <div class="blog-content">
                            <h4 class="blog-title">
                                <a href="#">Everything In Soccer Starts The Premier League</a>
                            </h4>
                            <div class="blog-desc"> The snatch is a wide-grip, one-move lift. The clean and jerk is a close-grip, two-move lift. Each...</div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="blog-item ">
                        <div class="blog-img">
                            <div class="image-wrap">
                                <a href="#"><img src="images/club-news/3.jpg" alt=""></a>
                            </div>
                            <div class="all-meta">
                                <div class="meta meta-date">
                                    <span class="month-day">20</span>
                        ...
                        <div class="blog-content">
                            <h4 class="blog-title">
                                <a href="#">Latest Point Table Stats For The Premier League</a>
                            </h4>
                            <div class="blog-desc"> The snatch is a wide-grip, one-move lift. The clean and jerk is a close-grip, two-move lift. Each...</div>
                        </div>
                    </div>
